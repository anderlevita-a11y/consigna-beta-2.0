...
import { Loader2, Ticket, Trophy, Info, Upload, CheckCircle2 } from 'lucide-react';
        ...
        <div className="bg-white rounded-[40px] p-8 sm:p-12 shadow-sm text-center space-y-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
            <div className="bg-zinc-50 px-6 py-3 rounded-2xl">
              ...
              <p className="text-xl font-bold text-emerald-600">R$ {raffle.ticket_price.toFixed(2)}</p>
            </div>
            <div className="bg-zinc-50 px-6 py-3 rounded-2xl">
        ...
        {step === 'form' && (
          <div className="bg-white rounded-[40px] p-8 sm:p-12 shadow-sm max-w-xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-emerald-50 text-emerald-600 font-bold text-2xl mb-4">
        ...
        {step === 'payment' && (
          <div className="bg-white rounded-[40px] p-8 sm:p-12 shadow-sm max-w-xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="bg-zinc-50 rounded-3xl p-6 mb-8 text-center">
              ...
              <p className="text-4xl font-bold text-emerald-600">R$ {raffle.ticket_price.toFixed(2)}</p>
            </div>
        ...
        {step === 'success' && (
          <div className="bg-white rounded-[40px] p-8 sm:p-12 shadow-sm max-w-xl mx-auto text-center animate-in zoom-in-95 duration-500">
            ...
            <p className="text-zinc-600 mb-8">
              Seu comprovante foi enviado e o número <strong className="text-emerald-600">{String(selectedNumber).padStart(3, '0')}</strong> está reservado. 
